...
<body>
    ...
    <header>
        <img src="img/image_accueil_luffy.png" alt="">
        <h1>CV Monkey D. Luffy</h1>
    ...
    <main>
        ...
        <section class="xp" id="Experience">
            ...
            <div class="timeline">
                ...
                <div class="timeline-box left b1">
                    <div class="left-point"></div>
                    <h3>Date - Lieu</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem?</p>
                </div>
                <div class="timeline-box right b2">
                    <div class="right-point"></div>
                    <h3>Date - Lieu</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem?</p>
                </div>
                <div class="image-luffy y21"></div>
                <div class="timeline-box left b3">
                    <div class="left-point"></div>
                    <h3>Date - Lieu</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem?</p>
                </div>
                <div class="timeline-box right b4">
                    <div class="right-point"></div>
                    <h3>Date - Lieu</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem?</p>
                </div>
                <div class="image-luffy wano"></div>
                <div class="timeline-box left b5">
                    <div class="left-point"></div>
                    <h3>Date - Lieu</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem?</p>
                </div>
            ...
            <section class="resume" id="Resume">
                ...
                <div class="resumeBoxes">
                    <img src="Avis_recherche/Luffy_lucy_preview_rev_1.png">
                </div>
